...
def _cart_id(request): #private function initialised by _ at beginning
    ...
    if current_user.is_authenticated:
        ...
        if is_cart_item_exists:
            ...
            for item in cart_item:
                ...
                id.append(item.id)
            if product_variation in ex_var_list: # increase cart item quantity
...
#for removing a product from cart irrespective of quantity
